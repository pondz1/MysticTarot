...
export const ELEMENT_STYLE_MAP: Record<ElementType, ElementStyle> = {
  fire: {
    bg: 'bg-slate-900/70 hover:bg-slate-800/70',
    activeBg: 'bg-gradient-to-b from-amber-500/20 via-slate-900 to-slate-950',
  ...
  water: {
    bg: 'bg-slate-900/70 hover:bg-slate-800/70',
    activeBg: 'bg-gradient-to-b from-cyan-500/20 via-slate-900 to-slate-950',
  ...
  air: {
    bg: 'bg-slate-900/70 hover:bg-slate-800/70',
    activeBg: 'bg-gradient-to-b from-purple-500/20 via-slate-900 to-slate-950',
  ...
  earth: {
    bg: 'bg-slate-900/70 hover:bg-slate-800/70',
    activeBg: 'bg-gradient-to-b from-emerald-500/20 via-slate-900 to-slate-950',
