...
export const DeckModeSelector: React.FC<DeckModeSelectorProps> = ({
  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-1 sm:px-2 my-2">
      {/* 5-Tab 100% Visible Segmented Bar (Zero Scroll Needed) */}
        ...
        {modes.map((modeItem) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col xs:flex-row items-center justify-center gap-0.5 xs:gap-1 sm:gap-1.5 py-1.5 px-0.5 xs:px-1.5 sm:px-3 rounded-xl transition-all duration-200 cursor-pointer disabled:opacity-50 text-center ${
                isSelected
            ...
            >
              ...
              <span className="text-[9px] xs:text-[10px] sm:text-xs truncate">
