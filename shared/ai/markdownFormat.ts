/**
 * Single source of truth for AI markdown output contract + master directives.
 * Imported by client (custom prompts / fallbacks) and server (credit prompts).
 */
...
/** Offline/fallback markdown that matches the same structure */
